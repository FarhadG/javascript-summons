...
describe("Change Base", function() {
  it("change numbers from base 10 to another", function() {
    ...
    expect(changeBase(10, 10, 16)).to.eql("a");
  })

  it("change numbers from base 2 to another", function() {
    expect(changeBase(101, 2, 10)).to.eql(5);
    expect(changeBase(10011, 2, 8)).to.eql(23);
    expect(changeBase(2, 2, 16)).to.eql("4b");
  })

  it("change numbers from any base to another", function() {
