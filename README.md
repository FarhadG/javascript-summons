...
These summons were inspired by the many wonderful resources (i.e. RubyMonk, Hack Reactor, CoderByte, JS Koans, App Academy, etc.) that challenge developers everyday to become better.